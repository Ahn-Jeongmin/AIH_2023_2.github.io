...
def EandI_classification(f_path):
    ...
    plt.ylabel('Count')
    plt.title('Count of E and I_1984')
    plt.show()
...
def NandS_classification(f_path):
    ...
    plt.bar(labels, counts, color=['skyblue', 'orange'])
    plt.xlabel('Personality Types_1984')
    plt.ylabel('Count')
...
#exe
path_list=[
    "C:\\Users\\jordi\\OneDrive\\바탕 화면\\23-2 연구\\data_set\\character_line\\1984\\1984_Winston_INTP.csv"
]
