...
def EandI_classification(f_path):
    ...
    plt.ylabel('Count')
    plt.title('Count of E and I_Death of a Salesman')
    plt.show()
...
def NandS_classification(f_path):
    ...
    plt.bar(labels, counts, color=['skyblue', 'orange'])
    plt.xlabel('Personality Types_Death of a Salesman')
    plt.ylabel('Count')
...
#exe
path_list=[
    "C:\\Users\\jordi\\OneDrive\\바탕 화면\\23-2 연구\\data_set\\character_line\\Death_of_a_Salesman\\DeathofaSalesman_LindaLoman_ENFJ.csv",
    "C:\\Users\\jordi\\OneDrive\\바탕 화면\\23-2 연구\\data_set\\character_line\\Death_of_a_Salesman\\DeathofaSalesman_WillyLoman_ISTJ.csv"
]
