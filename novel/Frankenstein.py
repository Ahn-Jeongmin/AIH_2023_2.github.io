...
def EandI_classification(f_path):
    ...
    plt.ylabel('Count')
    plt.title('Count of E and I_Frankenstein')
    plt.show()
...
def NandS_classification(f_path):
    ...
    plt.bar(labels, counts, color=['skyblue', 'orange'])
    plt.xlabel('Personality Types_Frankenstein')
    plt.ylabel('Count')
...
#exe
path_list=[
    "C:\\Users\\jordi\\OneDrive\\바탕 화면\\23-2 연구\\data_set\\character_line\\Frankenstien\\Frankenstien_Frankenstein_INTP.csv",
    "C:\\Users\\jordi\\OneDrive\\바탕 화면\\23-2 연구\\data_set\\character_line\\Frankenstien\\Frankenstien_Creature_INFP.csv",
    "C:\\Users\\jordi\\OneDrive\\바탕 화면\\23-2 연구\\data_set\\character_line\\Frankenstien\\Frankenstien_DeLacey_INFJ.csv"
]
