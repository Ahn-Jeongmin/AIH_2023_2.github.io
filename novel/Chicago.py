...
def EandI_classification(f_path):
    ...
    plt.ylabel('Count')
    plt.title('Count of E and I_Chicago')
    plt.show()
...
def NandS_classification(f_path):
    ...
    plt.bar(labels, counts, color=['skyblue', 'orange'])
    plt.xlabel('Personality Types_Chicago')
    plt.ylabel('Count')
...
#exe
path_list=[
    "C:\\Users\\jordi\\OneDrive\\바탕 화면\\23-2 연구\\data_set\\character_line\\Chicago\\Chicago_Billy_ENTP.csv",
    "C:\\Users\\jordi\\OneDrive\\바탕 화면\\23-2 연구\\data_set\\character_line\\Chicago\\Chicago_Roxie_ESFP.csv",
    "C:\\Users\\jordi\\OneDrive\\바탕 화면\\23-2 연구\\data_set\\character_line\\Chicago\\Chicago_Velma_ESTP.csv"
]
