...
def EandI_classification(f_path):
    ...
    plt.ylabel('Count')
    plt.title('Count of E and I_Animal Farm')
    plt.show()
...
def NandS_classification(f_path):
    ...
    plt.bar(labels, counts, color=['skyblue', 'orange'])
    plt.xlabel('Personality Types_Animal Farm')
    plt.ylabel('Count')
...
#exe
path_list=[
    "C:\\Users\\jordi\\OneDrive\\바탕 화면\\23-2 연구\\data_set\\character_line\\Animal_Farm\\AnimalFarm_Boxer_ISFJ.csv",
    "C:\\Users\\jordi\\OneDrive\\바탕 화면\\23-2 연구\\data_set\\character_line\\Animal_Farm\\AnimalFarm_Napoleon_ENTJ.csv",
    "C:\\Users\\jordi\\OneDrive\\바탕 화면\\23-2 연구\\data_set\\character_line\\Animal_Farm\\AnimalFarm_Snowball_INTJ.csv"
]
